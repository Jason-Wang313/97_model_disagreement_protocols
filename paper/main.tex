...
The terminal decision is \texttt{KILL\_ARCHIVE}. The paper should not be submitted to ICLR main. A revival would require a new empirical project showing that the full type-to-protocol mechanism beats robust fallback and failure-aware recovery on real or high-fidelity robot tasks.
