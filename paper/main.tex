...
\usepackage{url}
\usepackage{booktabs}
\title{Model Disagreement Protocols: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about ensembles and world models for robots. The original research bet was: Define action protocols that distinguish useful model disagreement from noise. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item ManipArena: Comprehensive Real-world Evaluation of Reasoning-Oriented Generalist Robot Manipulation (2026)
\item Benchmarking Robust Machine Learning Models Under Data Imperfections in Real-World Data Science Scenarios (2026)
\item Failure-Aware RL: Reliable Offline-to-Online Reinforcement Learning with Self-Recovery for Real-World Manipulation (2026)
\item Evaluating Large Language Model Ensembles as Probabilistic Forecasters: An Empirical Study on Live Real-World Events (n.d.)
\item Agile science: creating useful products for behavior change in the real world (2016)
\end{itemize}
